...
| 3 | LiveTalk | livetalk-env | ✅ | ✅ | ✅ 23G | ✅ | ✅ 1 test | 无 | 最小推理已通过 |
| 4 | Hallo3 | hallo3-env | ✅ | ✅ | ✅ 49G | ✅ | ✅ 1 test | 无 | 最小推理已通过 |
| 5 | Ovi | ovi-env | ✅ | ✅ | ✅ 83G | ✅ | ✅ 1 test | 无 | 最小推理已通过；qint8+cpu_offload |
...
| Condition | 状态 | 备注 |
|-----------|------|------|
| C_zh_5s ~ C_en_3m | ✅ done | 9 条件 |
| C_en_5m | ⚠️ | frame_seq_length=1024 限制，最大 254s |
| C_sing_zh, C_sing_en | ✅ done | |
...
| C_zh_10s | ✅ done | 755KB |
| C_zh_30s | ✅ done | 2.3MB |
| C_zh_1m ~ C_sing_en | ❌ 未完成 | GPU 冲突/OOM 中断 |
