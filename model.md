...
| 19 | InfiniteTalk | unified-env | ✅ | ✅ | ✅ 最小推理所需权重已齐 | ✅ | ✅ 1 test | ⚠️ 首轮中断待续跑 | 已完成 `C_half_short`；`C_full_short` 于 2026-03-08 17:54-18:00 因 OOM 中断，待 GPU 空闲后复跑；results.md 已补充 streaming 长短时说明 |
