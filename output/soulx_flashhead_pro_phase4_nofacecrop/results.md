# SoulX-FlashHead Pro Phase 4 结果（无 face_crop）
...
|-----------|------|------|------|---------|------|
| C_half_short | EM2_no_smoking.wav (~5.4s) | half_body/13.png | ~79s | 280K | 无编译开销（复用缓存） |
| C_half_long | A001.wav (~100s) | half_body/2.png | ~236s | 14M | 无编译开销 |
| C_full_short | S002_adele.wav (~8.6s) | full_body/1.png | ~80s | 612K | 全身图直接输入，无人脸裁剪 |
| C_full_long | MT_eng.wav (~60s) | full_body/3.png | ~166s | 3.3M | 全身图直接输入，无人脸裁剪 |
