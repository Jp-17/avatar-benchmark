...
- 配置文件：output/echomimic_v2/config.json
- 输出目录：output/echomimic_v2/
...
## 结果记录
- C_half_short：output/echomimic_v2/C_half_short.mp4
- C_half_long：output/echomimic_v2/C_half_long.mp4
- C_full_short：output/echomimic_v2/C_full_short.mp4
- C_full_long：output/echomimic_v2/C_full_long.mp4
