  ...
  cat > "$OUT_DIR/config.json" <<JSON
{
  ...
  "phase": "Phase 4 long-audio probe",
  "mode": "audio_encode_mode=stream",
  "cpu_offload": true,
  "seed": "default",
  "reference_short_dir": "output/soulx_flashtalk_newphase4",
...
write_config_json
init_results_md
run_case C_full_long /root/autodl-tmp/avatar-benchmark/input/avatar_img/filtered/full_body/3.png /root/autodl-tmp/avatar-benchmark/input/audio/filtered/long/MT_eng.wav singing
