...
RUN_LOG=$BASE/run_phase2_minimal_retry2.log
STATUS_FILE=$BASE/run_phase2_minimal_retry2.status
MODELS=(liveavatar soulx-flashtalk ltx2 omniavatar fantasy-talking)
printf '' > "$RUN_LOG"
printf '' > "$STATUS_FILE"
