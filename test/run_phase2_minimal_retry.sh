...
RUN_LOG=$BASE/run_phase2_minimal_retry.log
STATUS_FILE=$BASE/run_phase2_minimal_retry.status
MODELS=(echomimic_v2 livetalk wan2.2-s2v liveavatar soulx-flashtalk ltx2 omniavatar fantasy-talking stableavatar mova hallo3)
printf '' > "$RUN_LOG"
printf '' > "$STATUS_FILE"
