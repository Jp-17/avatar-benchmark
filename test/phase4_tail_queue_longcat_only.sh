...
LOG=/root/autodl-tmp/avatar-benchmark/test/phase4_tail_queue_longcat_only.log
PID=/root/autodl-tmp/avatar-benchmark/test/phase4_tail_queue_longcat_only.pid
: > "$LOG"
echo $$ > "$PID"
exec > >(tee -a "$LOG") 2>&1
