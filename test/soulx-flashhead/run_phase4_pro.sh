#!/bin/bash
# SoulX-FlashHead Phase 4 批推理脚本 - Pro 版本
# 4 个 condition，顺序执行（在 Lite 完成后启动）
...
OUTPUT_DIR=$PROJ_ROOT/output/soulx_flashhead_pro_phase4
...
log "=== SoulX-FlashHead Pro Phase 4 开始 ==="
...
log "=== SoulX-FlashHead Pro Phase 4 全部完成 ==="
